...
//	gamma = (0.8 - (s_brightness_slider[s_current_menu_index].curvalue/10.0 - 0.5)) + 0.5;
	...
	case 10:
		...
		break;
	case 9:
		Cvar_SetValue ("r_displayrefresh", 140);
		break;
	case 8:
...
//		"[Rendition OpenGL]",
	...
	static const char *refreshrate_names[] = 
	{
		...
		"[110Hz  ]",
		"[120Hz  ]",
		"[140Hz  ]", /* FS: I have a 21" CRT that can do this for 1024x748 and lower */
		"[144Hz  ]",
		"[150Hz  ]",
		0
	};
...
void VID_MenuDraw (void)
{
	...
	*/
	...
	re.DrawPic( viddef.width / 2 - w / 2, viddef.height /2 - 110, "m_banner_video", SCALEZERO);
