...
#define CONSOLE_WINDOW_CLASS_NAME	"Q2DOS Console"

#ifdef DEDICATED_ONLY
#define CONSOLE_WINDOW_NAME		"Q2DOS Dedicated Console"
#else
#define CONSOLE_WINDOW_NAME			"Q2DOS Console"
#endif
...
void Sys_InitDedConsole (void)
{
	...
	sys_console.hWndMsg = CreateWindowEx(0, "STATIC", "", WS_CHILD | SS_SUNKEN, 5, 5+ERR_MSG_OFFSET, 530, 30, sys_console.hWnd, NULL, global_hInstance, NULL); // was 5, 5, 530, 30
...
//	sys_console.hWndLogo = CreateWindowEx(0, "STATIC", "", WS_CHILD | WS_VISIBLE | SS_BITMAP | SS_CENTERIMAGE, 6, 41+LOGO_OFFSET, 512, 348, sys_console.hWnd, NULL, global_hInstance, NULL);
	sys_console.hLogoImage = (HBITMAP)LoadImage(global_hInstance, MAKEINTRESOURCE(IDB_BITMAP3),IMAGE_BITMAP,0,0,LR_LOADMAP3DCOLORS);
...
//	sys_console.hBrushOutput = CreatePatternBrush(sys_console.hLogoImage);
