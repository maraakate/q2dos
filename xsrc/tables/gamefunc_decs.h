...
extern void Com_sprintf ( char * dest , int size , const char * fmt , ... ) __attribute__((__format__(__printf__,3,4)));
...
extern char * va ( const char * format , ... ) __attribute__((__format__(__printf__,1,2)));
...
extern void SV_RealBoundingBox ( edict_t * ent , vec3_t mins , vec3_t maxs ) ;
...
extern void Com_Printf ( const char * msg , ... ) __attribute__((__format__(__printf__,1,2)));
extern void Sys_Error ( const char * error , ... ) __attribute__((__format__(__printf__,1,2)));
