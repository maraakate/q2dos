...
extern void sentien_fend ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void Com_strcat ( char * dest , int destSize , const char * src ) ;
extern void Com_strcpy ( char * dest , int destSize , const char * src ) ;
...
extern void weapon_grenade_fire_rogue ( edict_t * ent , qboolean held ) ;
...
extern void hook_fire ( edict_t * ent ) ;
extern void fire_hook ( edict_t * owner , vec3_t start , vec3_t forward ) ;
...
extern qboolean hook_cond_reset ( edict_t * self ) ;
extern void hook_reset ( edict_t * rhook ) ;
extern edict_t * hook_laser_start ( edict_t * ent ) ;
extern void hook_laser_think ( edict_t * self ) ;
extern int P_Clients_Connected ( qboolean spectators ) ;
...
extern void ClientShowMOTD ( edict_t * ent ) ;
...
extern void soldierh_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void soldier_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void soldier_attack_rogue ( edict_t * self ) ;
...
extern void soldier_fire_rogue ( edict_t * self , int in_flash_number ) ;
...
extern qboolean SV_movestep_zaero ( edict_t * ent , vec3_t move , qboolean relink ) ;
...
extern void SP_monster_medic_rogue ( edict_t * self ) ;
...
extern void medic_cable_attack_rogue ( edict_t * self ) ;
extern void medic_hook_launch ( edict_t * self ) ;
extern void medic_continue ( edict_t * self ) ;
extern void medic_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void medic_search_rogue ( edict_t * self ) ;
extern void medic_idle ( edict_t * self ) ;
extern void medic_idle_rogue ( edict_t * self ) ;
extern edict_t * medic_FindDeadMonster ( edict_t * self ) ;
extern edict_t * medic_FindDeadMonster_rogue ( edict_t * self ) ;
...
extern void infantry_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void GunnerGrenade_Rogue ( edict_t * self ) ;
...
extern void gunner_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void gekk_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void ChickRocket_Rogue ( edict_t * self ) ;
extern void ChickSlash ( edict_t * self ) ;
extern void chick_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void brain_dodge ( edict_t * self , edict_t * attacker , float eta , trace_t * fake ) ;
...
extern void fire_heat_xatrix ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , float damage_radius , int radius_damage ) ;
...
extern void VoteMenuInit ( edict_t * ent ) ;
extern void VoteMenuUpdate ( edict_t * ent ) ;
extern void vote_progress ( edict_t * ent ) ;
extern void vote_DefaultNoVotes ( void ) ;
extern qboolean Vote_Check_Random_History ( const char * mapname ) ;
extern void Vote_Clear_Random_History ( void ) ;
extern void Vote_Random_History_Add ( const char * mapname ) ;
extern void vote_connect ( edict_t * ent ) ;
extern void vote_Think ( void ) ;
extern void vote_updateMenu ( void ) ;
extern void vote_Decide ( void ) ;
extern void vote_Broadcast ( const char * fmt , ... ) ;
extern void vote_Failed ( qboolean bTied ) ;
extern void vote_Passed ( void ) ;
extern void vote_Reset ( void ) ;
extern void vote_disconnect_recalc ( edict_t * ent ) ;
extern void vote_no ( edict_t * ent ) ;
extern void vote_yes ( edict_t * ent , qboolean bAssume ) ;
...
extern qboolean G_SpawnCheck ( int cap ) ;
...
extern float vectoyaw_rogue ( vec3_t vec ) ;
...
extern float Coop_Players_In_Range ( edict_t * activator ) ;
extern void changelevel_dummy ( edict_t * self ) ;
...
extern void G_CheckCoopVictory ( void ) ;
extern int G_SpawnCheckpoints ( edict_t * ent ) ;
extern qboolean Spawn_CheckCoop_MapHacks ( edict_t * ent ) ;
extern void SP_SetCDTrack ( int track ) ;
...
extern void monster_fire_heat_xatrix ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int flashtype ) ;
...
extern void barrel_touch_zaero ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void SP_func_explosive ( edict_t * self ) ;
extern void SP_func_explosive_rogue ( edict_t * self ) ;
...
extern void G_ResetTimer_Hack ( void ) ;
...
extern qboolean Pickup_CoopBackpack ( edict_t * ent , edict_t * other ) ;
extern void Spawn_CoopBackpack ( edict_t * ent ) ;
...
extern void rotating_use_zaero ( edict_t * self , edict_t * other , edict_t * activator ) ;
...
extern void Move_Calc_Zaero ( edict_t * ent , vec3_t dest , void ( * func ) ( edict_t * ) , int smoothSpeedChange ) ;
...
extern void CoopVotePlayerReq ( edict_t * ent , pmenuhnd_t * p ) ;
...
extern void sayCmd_CheckVote ( edict_t * ent , char * voteChat ) ;
...
extern void ai_run_rogue ( edict_t * self , float dist ) ;
...
extern void ai_run_slide_rogue ( edict_t * self , float distance ) ;
...
extern void Cmd_Flashlight ( edict_t * ent ) ;
extern void Use_Flashlight ( edict_t * player ) ;
extern void flashlight_think ( edict_t * self ) ;
extern void FlashlightReset ( edict_t * self ) ;
