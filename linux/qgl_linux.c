...
#if defined(GLIMP_GLX)
#include <GL/glx.h>
#include <dlfcn.h>

#elif defined(GLIMP_SDL)
#ifdef __APPLE__
#include <SDL/SDL.h>
#else
#include "SDL.h"
...
#else
#error Neither of GLIMP_GLX or GLIMP_SDL defined
#endif
...
*/
#if defined(GLIMP_SDL)
static void QGL_CloseGLLib (void *lib) {
	/* SDL-1.2 doesn't provide an SDL_GL_UnloadLibrary(): it
	 * closes the library when the opengl context is destroyed
	 * by way of SDL_VideoQuit() . */
}
#elif defined(GLIMP_GLX)
static void QGL_CloseGLLib (void *lib) {
	dlclose (lib);
}
#endif
void QGL_Shutdown( void )
{
	...
	{
		QGL_CloseGLLib (glw_state.OpenGLLib);
...
*/
#if defined(GLIMP_SDL)
static qboolean QGL_InitSDL (void) {
	if (!SDL_WasInit(SDL_INIT_VIDEO) && SDL_InitSubSystem(SDL_INIT_VIDEO) < 0) {
		ri.Con_Printf(PRINT_ALL, "SDL Init failed: %s\n", SDL_GetError());
		return false;
	}
	return true;
}
static void *QGL_LoadGLLib (const char *dllname) {
	if (!QGL_InitSDL())
		return NULL;
	/* if opengl context is not destroyed by SDL_VideoQuit()
	 * SDL_GL_LoadLibrary() fail . */
	if (SDL_GL_LoadLibrary((*dllname)? dllname : NULL) == -1) {
		ri.Con_Printf(PRINT_ALL, "%s\n", SDL_GetError());
		return NULL;
	}
	return (void *)1; /* just a dummy value */
}
#elif defined(GLIMP_GLX)
static void *QGL_LoadGLLib (const char *dllname) {
	void *lib = dlopen(dllname, RTLD_LAZY | RTLD_GLOBAL);
	if(!lib) ri.Con_Printf(PRINT_ALL, "%s\n", dlerror());
	return lib;
}
#endif
qboolean QGL_Init(const char *dllname)
{
	...
	if (!(glw_state.OpenGLLib = QGL_LoadGLLib(dllname)))
		return false;

	qglAccum                    = dllAccum                  = (void (APIENTRY *)(GLenum,GLfloat)) GPA("glAccum");
	qglAlphaFunc                = dllAlphaFunc              = (void (APIENTRY *)(GLenum,GLclampf)) GPA("glAlphaFunc");
	qglAreTexturesResident      = dllAreTexturesResident    = (GLboolean (APIENTRY *)(GLsizei,const GLuint*,GLboolean*)) GPA("glAreTexturesResident");
	qglArrayElement             = dllArrayElement           = (void (APIENTRY *)(GLint)) GPA("glArrayElement");
	qglBegin                    = dllBegin                  = (void (APIENTRY *)(GLenum)) GPA("glBegin");
	qglBindTexture              = dllBindTexture            = (void (APIENTRY *)(GLenum,GLuint)) GPA("glBindTexture");
	qglBitmap                   = dllBitmap                 = (void (APIENTRY *)(GLsizei,GLsizei,GLfloat,GLfloat,GLfloat,GLfloat,const GLubyte*)) GPA("glBitmap");
	qglBlendFunc                = dllBlendFunc              = (void (APIENTRY *)(GLenum,GLenum)) GPA("glBlendFunc");
	qglCallList                 = dllCallList               = (void (APIENTRY *)(GLuint)) GPA("glCallList");
	qglCallLists                = dllCallLists              = (void (APIENTRY *)(GLsizei,GLenum,const GLvoid*)) GPA("glCallLists");
	qglClear                    = dllClear                  = (void (APIENTRY *)(GLbitfield)) GPA("glClear");
	qglClearAccum               = dllClearAccum             = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat,GLfloat)) GPA("glClearAccum");
	qglClearColor               = dllClearColor             = (void (APIENTRY *)(GLclampf,GLclampf,GLclampf,GLclampf)) GPA("glClearColor");
	qglClearDepth               = dllClearDepth             = (void (APIENTRY *)(GLclampd)) GPA("glClearDepth");
	qglClearIndex               = dllClearIndex             = (void (APIENTRY *)(GLfloat)) GPA("glClearIndex");
	qglClearStencil             = dllClearStencil           = (void (APIENTRY *)(GLint)) GPA("glClearStencil");
	qglClipPlane                = dllClipPlane              = (void (APIENTRY *)(GLenum,const GLdouble*)) GPA("glClipPlane");
	qglColor3b                  = dllColor3b                = (void (APIENTRY *)(GLbyte,GLbyte,GLbyte)) GPA("glColor3b");
	qglColor3bv                 = dllColor3bv               = (void (APIENTRY *)(const GLbyte*)) GPA("glColor3bv");
	qglColor3d                  = dllColor3d                = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble)) GPA("glColor3d");
	qglColor3dv                 = dllColor3dv               = (void (APIENTRY *)(const GLdouble*)) GPA("glColor3dv");
	qglColor3f                  = dllColor3f                = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat)) GPA("glColor3f");
	qglColor3fv                 = dllColor3fv               = (void (APIENTRY *)(const GLfloat*)) GPA("glColor3fv");
	qglColor3i                  = dllColor3i                = (void (APIENTRY *)(GLint,GLint,GLint)) GPA("glColor3i");
	qglColor3iv                 = dllColor3iv               = (void (APIENTRY *)(const GLint*)) GPA("glColor3iv");
	qglColor3s                  = dllColor3s                = (void (APIENTRY *)(GLshort,GLshort,GLshort)) GPA("glColor3s");
	qglColor3sv                 = dllColor3sv               = (void (APIENTRY *)(const GLshort*)) GPA("glColor3sv");
	qglColor3ub                 = dllColor3ub               = (void (APIENTRY *)(GLubyte,GLubyte,GLubyte)) GPA("glColor3ub");
	qglColor3ubv                = dllColor3ubv              = (void (APIENTRY *)(const GLubyte*)) GPA("glColor3ubv");
	qglColor3ui                 = dllColor3ui               = (void (APIENTRY *)(GLuint,GLuint,GLuint)) GPA("glColor3ui");
	qglColor3uiv                = dllColor3uiv              = (void (APIENTRY *)(const GLuint*)) GPA("glColor3uiv");
	qglColor3us                 = dllColor3us               = (void (APIENTRY *)(GLushort,GLushort,GLushort)) GPA("glColor3us");
	qglColor3usv                = dllColor3usv              = (void (APIENTRY *)(const GLushort*)) GPA("glColor3usv");
	qglColor4b                  = dllColor4b                = (void (APIENTRY *)(GLbyte,GLbyte,GLbyte,GLbyte)) GPA("glColor4b");
	qglColor4bv                 = dllColor4bv               = (void (APIENTRY *)(const GLbyte*)) GPA("glColor4bv");
	qglColor4d                  = dllColor4d                = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glColor4d");
	qglColor4dv                 = dllColor4dv               = (void (APIENTRY *)(const GLdouble*)) GPA("glColor4dv");
	qglColor4f                  = dllColor4f                = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat,GLfloat)) GPA("glColor4f");
	qglColor4fv                 = dllColor4fv               = (void (APIENTRY *)(const GLfloat*)) GPA("glColor4fv");
	qglColor4i                  = dllColor4i                = (void (APIENTRY *)(GLint,GLint,GLint,GLint)) GPA("glColor4i");
	qglColor4iv                 = dllColor4iv               = (void (APIENTRY *)(const GLint*)) GPA("glColor4iv");
	qglColor4s                  = dllColor4s                = (void (APIENTRY *)(GLshort,GLshort,GLshort,GLshort)) GPA("glColor4s");
	qglColor4sv                 = dllColor4sv               = (void (APIENTRY *)(const GLshort*)) GPA("glColor4sv");
	qglColor4ub                 = dllColor4ub               = (void (APIENTRY *)(GLubyte,GLubyte,GLubyte,GLubyte)) GPA("glColor4ub");
	qglColor4ubv                = dllColor4ubv              = (void (APIENTRY *)(const GLubyte*)) GPA("glColor4ubv");
	qglColor4ui                 = dllColor4ui               = (void (APIENTRY *)(GLuint,GLuint,GLuint,GLuint)) GPA("glColor4ui");
	qglColor4uiv                = dllColor4uiv              = (void (APIENTRY *)(const GLuint*)) GPA("glColor4uiv");
	qglColor4us                 = dllColor4us               = (void (APIENTRY *)(GLushort,GLushort,GLushort,GLushort)) GPA("glColor4us");
	qglColor4usv                = dllColor4usv              = (void (APIENTRY *)(const GLushort*)) GPA("glColor4usv");
	qglColorMask                = dllColorMask              = (void (APIENTRY *)(GLboolean,GLboolean,GLboolean,GLboolean)) GPA("glColorMask");
	qglColorMaterial            = dllColorMaterial          = (void (APIENTRY *)(GLenum,GLenum)) GPA("glColorMaterial");
	qglColorPointer             = dllColorPointer           = (void (APIENTRY *)(GLint,GLenum,GLsizei,const GLvoid*)) GPA("glColorPointer");
	qglCopyPixels               = dllCopyPixels             = (void (APIENTRY *)(GLint,GLint,GLsizei,GLsizei,GLenum)) GPA("glCopyPixels");
	qglCopyTexImage1D           = dllCopyTexImage1D         = (void (APIENTRY *)(GLenum,GLint,GLenum,GLint,GLint,GLsizei,GLint)) GPA("glCopyTexImage1D");
	qglCopyTexImage2D           = dllCopyTexImage2D         = (void (APIENTRY *)(GLenum,GLint,GLenum,GLint,GLint,GLsizei,GLsizei,GLint)) GPA("glCopyTexImage2D");
	qglCopyTexSubImage1D        = dllCopyTexSubImage1D      = (void (APIENTRY *)(GLenum,GLint,GLint,GLint,GLint,GLsizei)) GPA("glCopyTexSubImage1D");
	qglCopyTexSubImage2D        = dllCopyTexSubImage2D      = (void (APIENTRY *)(GLenum,GLint,GLint,GLint,GLint,GLint,GLsizei,GLsizei)) GPA("glCopyTexSubImage2D");
	qglCullFace                 = dllCullFace               = (void (APIENTRY *)(GLenum)) GPA("glCullFace");
	qglDeleteLists              = dllDeleteLists            = (void (APIENTRY *)(GLuint,GLsizei)) GPA("glDeleteLists");
	qglDeleteTextures           = dllDeleteTextures         = (void (APIENTRY *)(GLsizei,const GLuint*)) GPA("glDeleteTextures");
	qglDepthFunc                = dllDepthFunc              = (void (APIENTRY *)(GLenum)) GPA("glDepthFunc");
	qglDepthMask                = dllDepthMask              = (void (APIENTRY *)(GLboolean)) GPA("glDepthMask");
	qglDepthRange               = dllDepthRange             = (void (APIENTRY *)(GLclampd,GLclampd)) GPA("glDepthRange");
	qglDisable                  = dllDisable                = (void (APIENTRY *)(GLenum)) GPA("glDisable");
	qglDisableClientState       = dllDisableClientState     = (void (APIENTRY *)(GLenum)) GPA("glDisableClientState");
	qglDrawArrays               = dllDrawArrays             = (void (APIENTRY *)(GLenum,GLint,GLsizei)) GPA("glDrawArrays");
	qglDrawBuffer               = dllDrawBuffer             = (void (APIENTRY *)(GLenum)) GPA("glDrawBuffer");
	qglDrawElements             = dllDrawElements           = (void (APIENTRY *)(GLenum,GLsizei,GLenum,const GLvoid*)) GPA("glDrawElements");
	qglDrawPixels               = dllDrawPixels             = (void (APIENTRY *)(GLsizei,GLsizei,GLenum,GLenum,const GLvoid*)) GPA("glDrawPixels");
	qglEdgeFlag                 = dllEdgeFlag               = (void (APIENTRY *)(GLboolean)) GPA("glEdgeFlag");
	qglEdgeFlagPointer          = dllEdgeFlagPointer        = (void (APIENTRY *)(GLsizei,const GLvoid*)) GPA("glEdgeFlagPointer");
	qglEdgeFlagv                = dllEdgeFlagv              = (void (APIENTRY *)(const GLboolean*)) GPA("glEdgeFlagv");
	qglEnable                   = dllEnable                 = (void (APIENTRY *)(GLenum)) GPA("glEnable");
	qglEnableClientState        = dllEnableClientState      = (void (APIENTRY *)(GLenum)) GPA("glEnableClientState");
	qglEnd                      = dllEnd                    = (void (APIENTRY *)(void)) GPA("glEnd");
	qglEndList                  = dllEndList                = (void (APIENTRY *)(void)) GPA("glEndList");
	qglEvalCoord1d              = dllEvalCoord1d            = (void (APIENTRY *)(GLdouble)) GPA("glEvalCoord1d");
	qglEvalCoord1dv             = dllEvalCoord1dv           = (void (APIENTRY *)(const GLdouble*)) GPA("glEvalCoord1dv");
	qglEvalCoord1f              = dllEvalCoord1f            = (void (APIENTRY *)(GLfloat)) GPA("glEvalCoord1f");
	qglEvalCoord1fv             = dllEvalCoord1fv           = (void (APIENTRY *)(const GLfloat*)) GPA("glEvalCoord1fv");
	qglEvalCoord2d              = dllEvalCoord2d            = (void (APIENTRY *)(GLdouble,GLdouble)) GPA("glEvalCoord2d");
	qglEvalCoord2dv             = dllEvalCoord2dv           = (void (APIENTRY *)(const GLdouble*)) GPA("glEvalCoord2dv");
	qglEvalCoord2f              = dllEvalCoord2f            = (void (APIENTRY *)(GLfloat,GLfloat)) GPA("glEvalCoord2f");
	qglEvalCoord2fv             = dllEvalCoord2fv           = (void (APIENTRY *)(const GLfloat*)) GPA("glEvalCoord2fv");
	qglEvalMesh1                = dllEvalMesh1              = (void (APIENTRY *)(GLenum,GLint,GLint)) GPA("glEvalMesh1");
	qglEvalMesh2                = dllEvalMesh2              = (void (APIENTRY *)(GLenum,GLint,GLint,GLint,GLint)) GPA("glEvalMesh2");
	qglEvalPoint1               = dllEvalPoint1             = (void (APIENTRY *)(GLint)) GPA("glEvalPoint1");
	qglEvalPoint2               = dllEvalPoint2             = (void (APIENTRY *)(GLint,GLint)) GPA("glEvalPoint2");
	qglFeedbackBuffer           = dllFeedbackBuffer         = (void (APIENTRY *)(GLsizei,GLenum,GLfloat*)) GPA("glFeedbackBuffer");
	qglFinish                   = dllFinish                 = (void (APIENTRY *)(void)) GPA("glFinish");
	qglFlush                    = dllFlush                  = (void (APIENTRY *)(void)) GPA("glFlush");
	qglFogf                     = dllFogf                   = (void (APIENTRY *)(GLenum,GLfloat)) GPA("glFogf");
	qglFogfv                    = dllFogfv                  = (void (APIENTRY *)(GLenum,const GLfloat*)) GPA("glFogfv");
	qglFogi                     = dllFogi                   = (void (APIENTRY *)(GLenum,GLint)) GPA("glFogi");
	qglFogiv                    = dllFogiv                  = (void (APIENTRY *)(GLenum,const GLint*)) GPA("glFogiv");
	qglFrontFace                = dllFrontFace              = (void (APIENTRY *)(GLenum)) GPA("glFrontFace");
	qglFrustum                  = dllFrustum                = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glFrustum");
	qglGenLists                 = dllGenLists               = (GLuint (APIENTRY *)(GLsizei)) GPA("glGenLists");
	qglGenTextures              = dllGenTextures            = (void (APIENTRY *)(GLsizei,GLuint*)) GPA("glGenTextures");
	qglGetBooleanv              = dllGetBooleanv            = (void (APIENTRY *)(GLenum,GLboolean*)) GPA("glGetBooleanv");
	qglGetClipPlane             = dllGetClipPlane           = (void (APIENTRY *)(GLenum,GLdouble*)) GPA("glGetClipPlane");
	qglGetDoublev               = dllGetDoublev             = (void (APIENTRY *)(GLenum,GLdouble*)) GPA("glGetDoublev");
	qglGetError                 = dllGetError               = (GLenum (APIENTRY *)(void)) GPA("glGetError");
	qglGetFloatv                = dllGetFloatv              = (void (APIENTRY *)(GLenum,GLfloat*)) GPA("glGetFloatv");
	qglGetIntegerv              = dllGetIntegerv            = (void (APIENTRY *)(GLenum,GLint*)) GPA("glGetIntegerv");
	qglGetLightfv               = dllGetLightfv             = (void (APIENTRY *)(GLenum,GLenum,GLfloat*)) GPA("glGetLightfv");
	qglGetLightiv               = dllGetLightiv             = (void (APIENTRY *)(GLenum,GLenum,GLint*)) GPA("glGetLightiv");
	qglGetMapdv                 = dllGetMapdv               = (void (APIENTRY *)(GLenum,GLenum,GLdouble*)) GPA("glGetMapdv");
	qglGetMapfv                 = dllGetMapfv               = (void (APIENTRY *)(GLenum,GLenum,GLfloat*)) GPA("glGetMapfv");
	qglGetMapiv                 = dllGetMapiv               = (void (APIENTRY *)(GLenum,GLenum,GLint*)) GPA("glGetMapiv");
	qglGetMaterialfv            = dllGetMaterialfv          = (void (APIENTRY *)(GLenum,GLenum,GLfloat*)) GPA("glGetMaterialfv");
	qglGetMaterialiv            = dllGetMaterialiv          = (void (APIENTRY *)(GLenum,GLenum,GLint*)) GPA("glGetMaterialiv");
	qglGetPixelMapfv            = dllGetPixelMapfv          = (void (APIENTRY *)(GLenum,GLfloat*)) GPA("glGetPixelMapfv");
	qglGetPixelMapuiv           = dllGetPixelMapuiv         = (void (APIENTRY *)(GLenum,GLuint*)) GPA("glGetPixelMapuiv");
	qglGetPixelMapusv           = dllGetPixelMapusv         = (void (APIENTRY *)(GLenum,GLushort*)) GPA("glGetPixelMapusv");
	qglGetPointerv              = dllGetPointerv            = (void (APIENTRY *)(GLenum,GLvoid**)) GPA("glGetPointerv");
	qglGetPolygonStipple        = dllGetPolygonStipple      = (void (APIENTRY *)(GLubyte*)) GPA("glGetPolygonStipple");
	qglGetString                = dllGetString              = (const GLubyte* (APIENTRY *)(GLenum)) GPA("glGetString");
	qglGetTexEnvfv              = dllGetTexEnvfv            = (void (APIENTRY *)(GLenum,GLenum,GLfloat*)) GPA("glGetTexEnvfv");
	qglGetTexEnviv              = dllGetTexEnviv            = (void (APIENTRY *)(GLenum,GLenum,GLint*)) GPA("glGetTexEnviv");
	qglGetTexGendv              = dllGetTexGendv            = (void (APIENTRY *)(GLenum,GLenum,GLdouble*)) GPA("glGetTexGendv");
	qglGetTexGenfv              = dllGetTexGenfv            = (void (APIENTRY *)(GLenum,GLenum,GLfloat*)) GPA("glGetTexGenfv");
	qglGetTexGeniv              = dllGetTexGeniv            = (void (APIENTRY *)(GLenum,GLenum,GLint*)) GPA("glGetTexGeniv");
	qglGetTexImage              = dllGetTexImage            = (void (APIENTRY *)(GLenum,GLint,GLenum,GLenum,GLvoid*)) GPA("glGetTexImage");
	qglGetTexLevelParameterfv   = dllGetTexLevelParameterfv = (void (APIENTRY *)(GLenum,GLint,GLenum,GLfloat*)) GPA("glGetTexLevelParameterfv");
	qglGetTexLevelParameteriv   = dllGetTexLevelParameteriv = (void (APIENTRY *)(GLenum,GLint,GLenum,GLint*)) GPA("glGetTexLevelParameteriv");
	qglGetTexParameterfv        = dllGetTexParameterfv      = (void (APIENTRY *)(GLenum,GLenum,GLfloat*)) GPA("glGetTexParameterfv");
	qglGetTexParameteriv        = dllGetTexParameteriv      = (void (APIENTRY *)(GLenum,GLenum,GLint*)) GPA("glGetTexParameteriv");
	qglHint                     = dllHint                   = (void (APIENTRY *)(GLenum,GLenum)) GPA("glHint");
	qglIndexMask                = dllIndexMask              = (void (APIENTRY *)(GLuint)) GPA("glIndexMask");
	qglIndexPointer             = dllIndexPointer           = (void (APIENTRY *)(GLenum,GLsizei,const GLvoid*)) GPA("glIndexPointer");
	qglIndexd                   = dllIndexd                 = (void (APIENTRY *)(GLdouble)) GPA("glIndexd");
	qglIndexdv                  = dllIndexdv                = (void (APIENTRY *)(const GLdouble*)) GPA("glIndexdv");
	qglIndexf                   = dllIndexf                 = (void (APIENTRY *)(GLfloat)) GPA("glIndexf");
	qglIndexfv                  = dllIndexfv                = (void (APIENTRY *)(const GLfloat*)) GPA("glIndexfv");
	qglIndexi                   = dllIndexi                 = (void (APIENTRY *)(GLint)) GPA("glIndexi");
	qglIndexiv                  = dllIndexiv                = (void (APIENTRY *)(const GLint*)) GPA("glIndexiv");
	qglIndexs                   = dllIndexs                 = (void (APIENTRY *)(GLshort)) GPA("glIndexs");
	qglIndexsv                  = dllIndexsv                = (void (APIENTRY *)(const GLshort*)) GPA("glIndexsv");
	qglIndexub                  = dllIndexub                = (void (APIENTRY *)(GLubyte)) GPA("glIndexub");
	qglIndexubv                 = dllIndexubv               = (void (APIENTRY *)(const GLubyte*)) GPA("glIndexubv");
	qglInitNames                = dllInitNames              = (void (APIENTRY *)(void)) GPA("glInitNames");
	qglInterleavedArrays        = dllInterleavedArrays      = (void (APIENTRY *)(GLenum,GLsizei,const GLvoid*)) GPA("glInterleavedArrays");
	qglIsEnabled                = dllIsEnabled              = (GLboolean (APIENTRY *)(GLenum)) GPA("glIsEnabled");
	qglIsList                   = dllIsList                 = (GLboolean (APIENTRY *)(GLuint)) GPA("glIsList");
	qglIsTexture                = dllIsTexture              = (GLboolean (APIENTRY *)(GLuint)) GPA("glIsTexture");
	qglLightModelf              = dllLightModelf            = (void (APIENTRY *)(GLenum,GLfloat)) GPA("glLightModelf");
	qglLightModelfv             = dllLightModelfv           = (void (APIENTRY *)(GLenum,const GLfloat*)) GPA("glLightModelfv");
	qglLightModeli              = dllLightModeli            = (void (APIENTRY *)(GLenum,GLint)) GPA("glLightModeli");
	qglLightModeliv             = dllLightModeliv           = (void (APIENTRY *)(GLenum,const GLint*)) GPA("glLightModeliv");
	qglLightf                   = dllLightf                 = (void (APIENTRY *)(GLenum,GLenum,GLfloat)) GPA("glLightf");
	qglLightfv                  = dllLightfv                = (void (APIENTRY *)(GLenum,GLenum,const GLfloat*)) GPA("glLightfv");
	qglLighti                   = dllLighti                 = (void (APIENTRY *)(GLenum,GLenum,GLint)) GPA("glLighti");
	qglLightiv                  = dllLightiv                = (void (APIENTRY *)(GLenum,GLenum,const GLint*)) GPA("glLightiv");
	qglLineStipple              = dllLineStipple            = (void (APIENTRY *)(GLint,GLushort)) GPA("glLineStipple");
	qglLineWidth                = dllLineWidth              = (void (APIENTRY *)(GLfloat)) GPA("glLineWidth");
	qglListBase                 = dllListBase               = (void (APIENTRY *)(GLuint)) GPA("glListBase");
	qglLoadIdentity             = dllLoadIdentity           = (void (APIENTRY *)(void)) GPA("glLoadIdentity");
	qglLoadMatrixd              = dllLoadMatrixd            = (void (APIENTRY *)(const GLdouble*)) GPA("glLoadMatrixd");
	qglLoadMatrixf              = dllLoadMatrixf            = (void (APIENTRY *)(const GLfloat*)) GPA("glLoadMatrixf");
	qglLoadName                 = dllLoadName               = (void (APIENTRY *)(GLuint)) GPA("glLoadName");
	qglLogicOp                  = dllLogicOp                = (void (APIENTRY *)(GLenum)) GPA("glLogicOp");
	qglMap1d                    = dllMap1d                  = (void (APIENTRY *)(GLenum,GLdouble,GLdouble,GLint,GLint,const GLdouble*)) GPA("glMap1d");
	qglMap1f                    = dllMap1f                  = (void (APIENTRY *)(GLenum,GLfloat,GLfloat,GLint,GLint,const GLfloat*)) GPA("glMap1f");
	qglMap2d                    = dllMap2d                  = (void (APIENTRY *)(GLenum,GLdouble,GLdouble,GLint,GLint,GLdouble,GLdouble,GLint,GLint,const GLdouble*)) GPA("glMap2d");
	qglMap2f                    = dllMap2f                  = (void (APIENTRY *)(GLenum,GLfloat,GLfloat,GLint,GLint,GLfloat,GLfloat,GLint,GLint,const GLfloat*)) GPA("glMap2f");
	qglMapGrid1d                = dllMapGrid1d              = (void (APIENTRY *)(GLint,GLdouble,GLdouble)) GPA("glMapGrid1d");
	qglMapGrid1f                = dllMapGrid1f              = (void (APIENTRY *)(GLint,GLfloat,GLfloat)) GPA("glMapGrid1f");
	qglMapGrid2d                = dllMapGrid2d              = (void (APIENTRY *)(GLint,GLdouble,GLdouble,GLint,GLdouble,GLdouble)) GPA("glMapGrid2d");
	qglMapGrid2f                = dllMapGrid2f              = (void (APIENTRY *)(GLint,GLfloat,GLfloat,GLint,GLfloat,GLfloat)) GPA("glMapGrid2f");
	qglMaterialf                = dllMaterialf              = (void (APIENTRY *)(GLenum,GLenum,GLfloat)) GPA("glMaterialf");
	qglMaterialfv               = dllMaterialfv             = (void (APIENTRY *)(GLenum,GLenum,const GLfloat*)) GPA("glMaterialfv");
	qglMateriali                = dllMateriali              = (void (APIENTRY *)(GLenum,GLenum,GLint)) GPA("glMateriali");
	qglMaterialiv               = dllMaterialiv             = (void (APIENTRY *)(GLenum,GLenum,const GLint*)) GPA("glMaterialiv");
	qglMatrixMode               = dllMatrixMode             = (void (APIENTRY *)(GLenum)) GPA("glMatrixMode");
	qglMultMatrixd              = dllMultMatrixd            = (void (APIENTRY *)(const GLdouble*)) GPA("glMultMatrixd");
	qglMultMatrixf              = dllMultMatrixf            = (void (APIENTRY *)(const GLfloat*)) GPA("glMultMatrixf");
	qglNewList                  = dllNewList                = (void (APIENTRY *)(GLuint,GLenum)) GPA("glNewList");
	qglNormal3b                 = dllNormal3b               = (void (APIENTRY *)(GLbyte,GLbyte,GLbyte)) GPA("glNormal3b");
	qglNormal3bv                = dllNormal3bv              = (void (APIENTRY *)(const GLbyte*)) GPA("glNormal3bv");
	qglNormal3d                 = dllNormal3d               = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble)) GPA("glNormal3d");
	qglNormal3dv                = dllNormal3dv              = (void (APIENTRY *)(const GLdouble*)) GPA("glNormal3dv");
	qglNormal3f                 = dllNormal3f               = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat)) GPA("glNormal3f");
	qglNormal3fv                = dllNormal3fv              = (void (APIENTRY *)(const GLfloat*)) GPA("glNormal3fv");
	qglNormal3i                 = dllNormal3i               = (void (APIENTRY *)(GLint,GLint,GLint)) GPA("glNormal3i");
	qglNormal3iv                = dllNormal3iv              = (void (APIENTRY *)(const GLint*)) GPA("glNormal3iv");
	qglNormal3s                 = dllNormal3s               = (void (APIENTRY *)(GLshort,GLshort,GLshort)) GPA("glNormal3s");
	qglNormal3sv                = dllNormal3sv              = (void (APIENTRY *)(const GLshort*)) GPA("glNormal3sv");
	qglNormalPointer            = dllNormalPointer          = (void (APIENTRY *)(GLenum,GLsizei,const GLvoid*)) GPA("glNormalPointer");
	qglOrtho                    = dllOrtho                  = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glOrtho");
	qglPassThrough              = dllPassThrough            = (void (APIENTRY *)(GLfloat)) GPA("glPassThrough");
	qglPixelMapfv               = dllPixelMapfv             = (void (APIENTRY *)(GLenum,GLsizei,const GLfloat*)) GPA("glPixelMapfv");
	qglPixelMapuiv              = dllPixelMapuiv            = (void (APIENTRY *)(GLenum,GLsizei,const GLuint*)) GPA("glPixelMapuiv");
	qglPixelMapusv              = dllPixelMapusv            = (void (APIENTRY *)(GLenum,GLsizei,const GLushort*)) GPA("glPixelMapusv");
	qglPixelStoref              = dllPixelStoref            = (void (APIENTRY *)(GLenum,GLfloat)) GPA("glPixelStoref");
	qglPixelStorei              = dllPixelStorei            = (void (APIENTRY *)(GLenum,GLint)) GPA("glPixelStorei");
	qglPixelTransferf           = dllPixelTransferf         = (void (APIENTRY *)(GLenum,GLfloat)) GPA("glPixelTransferf");
	qglPixelTransferi           = dllPixelTransferi         = (void (APIENTRY *)(GLenum,GLint)) GPA("glPixelTransferi");
	qglPixelZoom                = dllPixelZoom              = (void (APIENTRY *)(GLfloat,GLfloat)) GPA("glPixelZoom");
	qglPointSize                = dllPointSize              = (void (APIENTRY *)(GLfloat)) GPA("glPointSize");
	qglPolygonMode              = dllPolygonMode            = (void (APIENTRY *)(GLenum,GLenum)) GPA("glPolygonMode");
	qglPolygonOffset            = dllPolygonOffset          = (void (APIENTRY *)(GLfloat,GLfloat)) GPA("glPolygonOffset");
	qglPolygonStipple           = dllPolygonStipple         = (void (APIENTRY *)(const GLubyte*)) GPA("glPolygonStipple");
	...
	qglPrioritizeTextures       = dllPrioritizeTextures     = (void (APIENTRY *)(GLsizei,const GLuint*,const GLclampf*)) GPA("glPrioritizeTextures");
	qglPushAttrib               = dllPushAttrib             = (void (APIENTRY *)(GLbitfield)) GPA("glPushAttrib");
	qglPushClientAttrib         = dllPushClientAttrib       = (void (APIENTRY *)(GLbitfield)) GPA("glPushClientAttrib");
	qglPushMatrix               = dllPushMatrix             = (void (APIENTRY *)(void)) GPA("glPushMatrix");
	qglPushName                 = dllPushName               = (void (APIENTRY *)(GLuint)) GPA("glPushName");
	qglRasterPos2d              = dllRasterPos2d            = (void (APIENTRY *)(GLdouble,GLdouble)) GPA("glRasterPos2d");
	qglRasterPos2dv             = dllRasterPos2dv           = (void (APIENTRY *)(const GLdouble*)) GPA("glRasterPos2dv");
	qglRasterPos2f              = dllRasterPos2f            = (void (APIENTRY *)(GLfloat,GLfloat)) GPA("glRasterPos2f");
	qglRasterPos2fv             = dllRasterPos2fv           = (void (APIENTRY *)(const GLfloat*)) GPA("glRasterPos2fv");
	qglRasterPos2i              = dllRasterPos2i            = (void (APIENTRY *)(GLint,GLint)) GPA("glRasterPos2i");
	qglRasterPos2iv             = dllRasterPos2iv           = (void (APIENTRY *)(const GLint*)) GPA("glRasterPos2iv");
	qglRasterPos2s              = dllRasterPos2s            = (void (APIENTRY *)(GLshort,GLshort)) GPA("glRasterPos2s");
	qglRasterPos2sv             = dllRasterPos2sv           = (void (APIENTRY *)(const GLshort*)) GPA("glRasterPos2sv");
	qglRasterPos3d              = dllRasterPos3d            = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble)) GPA("glRasterPos3d");
	qglRasterPos3dv             = dllRasterPos3dv           = (void (APIENTRY *)(const GLdouble*)) GPA("glRasterPos3dv");
	qglRasterPos3f              = dllRasterPos3f            = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat)) GPA("glRasterPos3f");
	qglRasterPos3fv             = dllRasterPos3fv           = (void (APIENTRY *)(const GLfloat*)) GPA("glRasterPos3fv");
	qglRasterPos3i              = dllRasterPos3i            = (void (APIENTRY *)(GLint,GLint,GLint)) GPA("glRasterPos3i");
	qglRasterPos3iv             = dllRasterPos3iv           = (void (APIENTRY *)(const GLint*)) GPA("glRasterPos3iv");
	qglRasterPos3s              = dllRasterPos3s            = (void (APIENTRY *)(GLshort,GLshort,GLshort)) GPA("glRasterPos3s");
	qglRasterPos3sv             = dllRasterPos3sv           = (void (APIENTRY *)(const GLshort*)) GPA("glRasterPos3sv");
	qglRasterPos4d              = dllRasterPos4d            = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glRasterPos4d");
	qglRasterPos4dv             = dllRasterPos4dv           = (void (APIENTRY *)(const GLdouble*)) GPA("glRasterPos4dv");
	qglRasterPos4f              = dllRasterPos4f            = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat,GLfloat)) GPA("glRasterPos4f");
	qglRasterPos4fv             = dllRasterPos4fv           = (void (APIENTRY *)(const GLfloat*)) GPA("glRasterPos4fv");
	qglRasterPos4i              = dllRasterPos4i            = (void (APIENTRY *)(GLint,GLint,GLint,GLint)) GPA("glRasterPos4i");
	qglRasterPos4iv             = dllRasterPos4iv           = (void (APIENTRY *)(const GLint*)) GPA("glRasterPos4iv");
	qglRasterPos4s              = dllRasterPos4s            = (void (APIENTRY *)(GLshort,GLshort,GLshort,GLshort)) GPA("glRasterPos4s");
	qglRasterPos4sv             = dllRasterPos4sv           = (void (APIENTRY *)(const GLshort*)) GPA("glRasterPos4sv");
	qglReadBuffer               = dllReadBuffer             = (void (APIENTRY *)(GLenum)) GPA("glReadBuffer");
	qglReadPixels               = dllReadPixels             = (void (APIENTRY *)(GLint,GLint,GLsizei,GLsizei,GLenum,GLenum,GLvoid*)) GPA("glReadPixels");
	qglRectd                    = dllRectd                  = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glRectd");
	qglRectdv                   = dllRectdv                 = (void (APIENTRY *)(const GLdouble*,const GLdouble*)) GPA("glRectdv");
	qglRectf                    = dllRectf                  = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat,GLfloat)) GPA("glRectf");
	qglRectfv                   = dllRectfv                 = (void (APIENTRY *)(const GLfloat*,const GLfloat*)) GPA("glRectfv");
	qglRecti                    = dllRecti                  = (void (APIENTRY *)(GLint,GLint,GLint,GLint)) GPA("glRecti");
	qglRectiv                   = dllRectiv                 = (void (APIENTRY *)(const GLint*,const GLint*)) GPA("glRectiv");
	qglRects                    = dllRects                  = (void (APIENTRY *)(GLshort,GLshort,GLshort,GLshort)) GPA("glRects");
	qglRectsv                   = dllRectsv                 = (void (APIENTRY *)(const GLshort*,const GLshort*)) GPA("glRectsv");
	qglRenderMode               = dllRenderMode             = (GLint (APIENTRY *)(GLenum)) GPA("glRenderMode");
	qglRotated                  = dllRotated                = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glRotated");
	qglRotatef                  = dllRotatef                = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat,GLfloat)) GPA("glRotatef");
	qglScaled                   = dllScaled                 = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble)) GPA("glScaled");
	qglScalef                   = dllScalef                 = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat)) GPA("glScalef");
	qglScissor                  = dllScissor                = (void (APIENTRY *)(GLint,GLint,GLsizei,GLsizei)) GPA("glScissor");
	qglSelectBuffer             = dllSelectBuffer           = (void (APIENTRY *)(GLsizei,GLuint*)) GPA("glSelectBuffer");
	qglShadeModel               = dllShadeModel             = (void (APIENTRY *)(GLenum)) GPA("glShadeModel");
	qglStencilFunc              = dllStencilFunc            = (void (APIENTRY *)(GLenum,GLint,GLuint)) GPA("glStencilFunc");
	qglStencilMask              = dllStencilMask            = (void (APIENTRY *)(GLuint)) GPA("glStencilMask");
	qglStencilOp                = dllStencilOp              = (void (APIENTRY *)(GLenum,GLenum,GLenum)) GPA("glStencilOp");
	qglTexCoord1d               = dllTexCoord1d             = (void (APIENTRY *)(GLdouble)) GPA("glTexCoord1d");
	qglTexCoord1dv              = dllTexCoord1dv            = (void (APIENTRY *)(const GLdouble*)) GPA("glTexCoord1dv");
	qglTexCoord1f               = dllTexCoord1f             = (void (APIENTRY *)(GLfloat)) GPA("glTexCoord1f");
	qglTexCoord1fv              = dllTexCoord1fv            = (void (APIENTRY *)(const GLfloat*)) GPA("glTexCoord1fv");
	qglTexCoord1i               = dllTexCoord1i             = (void (APIENTRY *)(GLint)) GPA("glTexCoord1i");
	qglTexCoord1iv              = dllTexCoord1iv            = (void (APIENTRY *)(const GLint*)) GPA("glTexCoord1iv");
	qglTexCoord1s               = dllTexCoord1s             = (void (APIENTRY *)(GLshort)) GPA("glTexCoord1s");
	qglTexCoord1sv              = dllTexCoord1sv            = (void (APIENTRY *)(const GLshort*)) GPA("glTexCoord1sv");
	qglTexCoord2d               = dllTexCoord2d             = (void (APIENTRY *)(GLdouble,GLdouble)) GPA("glTexCoord2d");
	qglTexCoord2dv              = dllTexCoord2dv            = (void (APIENTRY *)(const GLdouble*)) GPA("glTexCoord2dv");
	qglTexCoord2f               = dllTexCoord2f             = (void (APIENTRY *)(GLfloat,GLfloat)) GPA("glTexCoord2f");
	qglTexCoord2fv              = dllTexCoord2fv            = (void (APIENTRY *)(const GLfloat*)) GPA("glTexCoord2fv");
	qglTexCoord2i               = dllTexCoord2i             = (void (APIENTRY *)(GLint,GLint)) GPA("glTexCoord2i");
	qglTexCoord2iv              = dllTexCoord2iv            = (void (APIENTRY *)(const GLint*)) GPA("glTexCoord2iv");
	qglTexCoord2s               = dllTexCoord2s             = (void (APIENTRY *)(GLshort,GLshort)) GPA("glTexCoord2s");
	qglTexCoord2sv              = dllTexCoord2sv            = (void (APIENTRY *)(const GLshort*)) GPA("glTexCoord2sv");
	qglTexCoord3d               = dllTexCoord3d             = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble)) GPA("glTexCoord3d");
	qglTexCoord3dv              = dllTexCoord3dv            = (void (APIENTRY *)(const GLdouble*)) GPA("glTexCoord3dv");
	qglTexCoord3f               = dllTexCoord3f             = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat)) GPA("glTexCoord3f");
	qglTexCoord3fv              = dllTexCoord3fv            = (void (APIENTRY *)(const GLfloat*)) GPA("glTexCoord3fv");
	qglTexCoord3i               = dllTexCoord3i             = (void (APIENTRY *)(GLint,GLint,GLint)) GPA("glTexCoord3i");
	qglTexCoord3iv              = dllTexCoord3iv            = (void (APIENTRY *)(const GLint*)) GPA("glTexCoord3iv");
	qglTexCoord3s               = dllTexCoord3s             = (void (APIENTRY *)(GLshort,GLshort,GLshort)) GPA("glTexCoord3s");
	qglTexCoord3sv              = dllTexCoord3sv            = (void (APIENTRY *)(const GLshort*)) GPA("glTexCoord3sv");
	qglTexCoord4d               = dllTexCoord4d             = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glTexCoord4d");
	qglTexCoord4dv              = dllTexCoord4dv            = (void (APIENTRY *)(const GLdouble*)) GPA("glTexCoord4dv");
	qglTexCoord4f               = dllTexCoord4f             = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat,GLfloat)) GPA("glTexCoord4f");
	qglTexCoord4fv              = dllTexCoord4fv            = (void (APIENTRY *)(const GLfloat*)) GPA("glTexCoord4fv");
	qglTexCoord4i               = dllTexCoord4i             = (void (APIENTRY *)(GLint,GLint,GLint,GLint)) GPA("glTexCoord4i");
	qglTexCoord4iv              = dllTexCoord4iv            = (void (APIENTRY *)(const GLint*)) GPA("glTexCoord4iv");
	qglTexCoord4s               = dllTexCoord4s             = (void (APIENTRY *)(GLshort,GLshort,GLshort,GLshort)) GPA("glTexCoord4s");
	qglTexCoord4sv              = dllTexCoord4sv            = (void (APIENTRY *)(const GLshort*)) GPA("glTexCoord4sv");
	qglTexCoordPointer          = dllTexCoordPointer        = (void (APIENTRY *)(GLint,GLenum,GLsizei,const GLvoid*)) GPA("glTexCoordPointer");
	qglTexEnvf                  = dllTexEnvf                = (void (APIENTRY *)(GLenum,GLenum,GLfloat)) GPA("glTexEnvf");
	qglTexEnvfv                 = dllTexEnvfv               = (void (APIENTRY *)(GLenum,GLenum,const GLfloat*)) GPA("glTexEnvfv");
	qglTexEnvi                  = dllTexEnvi                = (void (APIENTRY *)(GLenum,GLenum,GLint)) GPA("glTexEnvi");
	qglTexEnviv                 = dllTexEnviv               = (void (APIENTRY *)(GLenum,GLenum,const GLint*)) GPA("glTexEnviv");
	qglTexGend                  = dllTexGend                = (void (APIENTRY *)(GLenum,GLenum,GLdouble)) GPA("glTexGend");
	qglTexGendv                 = dllTexGendv               = (void (APIENTRY *)(GLenum,GLenum,const GLdouble*)) GPA("glTexGendv");
	qglTexGenf                  = dllTexGenf                = (void (APIENTRY *)(GLenum,GLenum,GLfloat)) GPA("glTexGenf");
	qglTexGenfv                 = dllTexGenfv               = (void (APIENTRY *)(GLenum,GLenum,const GLfloat*)) GPA("glTexGenfv");
	qglTexGeni                  = dllTexGeni                = (void (APIENTRY *)(GLenum,GLenum,GLint)) GPA("glTexGeni");
	qglTexGeniv                 = dllTexGeniv               = (void (APIENTRY *)(GLenum,GLenum,const GLint*)) GPA("glTexGeniv");
	qglTexImage1D               = dllTexImage1D             = (void (APIENTRY *)(GLenum,GLint,GLint,GLsizei,GLint,GLenum,GLenum,const GLvoid*)) GPA("glTexImage1D");
	qglTexImage2D               = dllTexImage2D             = (void (APIENTRY *)(GLenum,GLint,GLint,GLsizei,GLsizei,GLint,GLenum,GLenum,const GLvoid*)) GPA("glTexImage2D");
	qglTexParameterf            = dllTexParameterf          = (void (APIENTRY *)(GLenum,GLenum,GLfloat)) GPA("glTexParameterf");
	qglTexParameterfv           = dllTexParameterfv         = (void (APIENTRY *)(GLenum,GLenum,const GLfloat*)) GPA("glTexParameterfv");
	qglTexParameteri            = dllTexParameteri          = (void (APIENTRY *)(GLenum,GLenum,GLint)) GPA("glTexParameteri");
	qglTexParameteriv           = dllTexParameteriv         = (void (APIENTRY *)(GLenum,GLenum,const GLint*)) GPA("glTexParameteriv");
	qglTexSubImage1D            = dllTexSubImage1D          = (void (APIENTRY *)(GLenum,GLint,GLint,GLsizei,GLenum,GLenum,const GLvoid*)) GPA("glTexSubImage1D");
	qglTexSubImage2D            = dllTexSubImage2D          = (void (APIENTRY *)(GLenum,GLint,GLint,GLint,GLsizei,GLsizei,GLenum,GLenum,const GLvoid*)) GPA("glTexSubImage2D");
	qglTranslated               = dllTranslated             = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble)) GPA("glTranslated");
	qglTranslatef               = dllTranslatef             = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat)) GPA("glTranslatef");
	qglVertex2d                 = dllVertex2d               = (void (APIENTRY *)(GLdouble,GLdouble)) GPA("glVertex2d");
	qglVertex2dv                = dllVertex2dv              = (void (APIENTRY *)(const GLdouble*)) GPA("glVertex2dv");
	qglVertex2f                 = dllVertex2f               = (void (APIENTRY *)(GLfloat,GLfloat)) GPA("glVertex2f");
	qglVertex2fv                = dllVertex2fv              = (void (APIENTRY *)(const GLfloat*)) GPA("glVertex2fv");
	qglVertex2i                 = dllVertex2i               = (void (APIENTRY *)(GLint,GLint)) GPA("glVertex2i");
	qglVertex2iv                = dllVertex2iv              = (void (APIENTRY *)(const GLint*)) GPA("glVertex2iv");
	qglVertex2s                 = dllVertex2s               = (void (APIENTRY *)(GLshort,GLshort)) GPA("glVertex2s");
	qglVertex2sv                = dllVertex2sv              = (void (APIENTRY *)(const GLshort*)) GPA("glVertex2sv");
	qglVertex3d                 = dllVertex3d               = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble)) GPA("glVertex3d");
	qglVertex3dv                = dllVertex3dv              = (void (APIENTRY *)(const GLdouble*)) GPA("glVertex3dv");
	qglVertex3f                 = dllVertex3f               = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat)) GPA("glVertex3f");
	qglVertex3fv                = dllVertex3fv              = (void (APIENTRY *)(const GLfloat*)) GPA("glVertex3fv");
	qglVertex3i                 = dllVertex3i               = (void (APIENTRY *)(GLint,GLint,GLint)) GPA("glVertex3i");
	qglVertex3iv                = dllVertex3iv              = (void (APIENTRY *)(const GLint*)) GPA("glVertex3iv");
	qglVertex3s                 = dllVertex3s               = (void (APIENTRY *)(GLshort,GLshort,GLshort)) GPA("glVertex3s");
	qglVertex3sv                = dllVertex3sv              = (void (APIENTRY *)(const GLshort*)) GPA("glVertex3sv");
	qglVertex4d                 = dllVertex4d               = (void (APIENTRY *)(GLdouble,GLdouble,GLdouble,GLdouble)) GPA("glVertex4d");
	qglVertex4dv                = dllVertex4dv              = (void (APIENTRY *)(const GLdouble*)) GPA("glVertex4dv");
	qglVertex4f                 = dllVertex4f               = (void (APIENTRY *)(GLfloat,GLfloat,GLfloat,GLfloat)) GPA("glVertex4f");
	qglVertex4fv                = dllVertex4fv              = (void (APIENTRY *)(const GLfloat*)) GPA("glVertex4fv");
	qglVertex4i                 = dllVertex4i               = (void (APIENTRY *)(GLint,GLint,GLint,GLint)) GPA("glVertex4i");
	qglVertex4iv                = dllVertex4iv              = (void (APIENTRY *)(const GLint*)) GPA("glVertex4iv");
	qglVertex4s                 = dllVertex4s               = (void (APIENTRY *)(GLshort,GLshort,GLshort,GLshort)) GPA("glVertex4s");
	qglVertex4sv                = dllVertex4sv              = (void (APIENTRY *)(const GLshort*)) GPA("glVertex4sv");
	qglVertexPointer            = dllVertexPointer          = (void (APIENTRY *)(GLint,GLenum,GLsizei,const GLvoid*)) GPA("glVertexPointer");
	qglViewport                 = dllViewport               = (void (APIENTRY *)(GLint,GLint,GLsizei,GLsizei)) GPA("glViewport");
	...
	qglXCopyContext             = (void (*)(Display*,GLXContext,GLXContext,unsigned long)) GPA("glXCopyContext");
