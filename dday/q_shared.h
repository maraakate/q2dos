...
#define MZ_NORMALGUN		32		// KMM: DDAY
...
#define	STAT_ROUNDS_ICON		2 //AMMO
#define	STAT_ROUNDS				3
#define	STAT_MAGS_ICON			4 //ARMOR
#define	STAT_MAGS				5
...
//#define STAT_CHASE				16	// pbowens: from 3.20 stock
//#define STAT_SPECTATOR			17	// pbowens: from 3.20 stock
#define STAT_OBJECTIVE			16
#define STAT_IDENT				17
...
#define CS_OBJECTIVES		(CS_GENERAL+MAX_CLIENTS)
